...
defined('USE_SHARED_CORE') or define('USE_SHARED_CORE', false);
...
defined('ENABLE_IPAD') or define('ENABLE_IPAD', 1);
defined('ENABLE_IPHONE') or define('ENABLE_IPHONE', 1);

// should we use browser caching?
defined('USE_CACHING') or define('USE_CACHING', false);
...
if (!strpos($_SERVER['SCRIPT_NAME'], 'css') && !strpos($_SERVER['SCRIPT_NAME'], 'images') && !strpos($_SERVER['SCRIPT_NAME'], 'js') && !strpos($_SERVER['REQUEST_URI'], 'css') ) {
	...
	define('SVN_REVISION', get_svn_version());
